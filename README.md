...
Nazwę tematu proszę wpisać w komentarzu do zajęć. Wybrany temat proszę opisać skrótowo na swoim repozytorium w pliku README.md, oraz wysłać adres repozytorium na email prowadzącego - pantadeusz@pjwstk.edu.pl - proszę w tytule wpisać "MHE Zaoczne 2025", dzięki czemu łatwiej mi będzie to zebrać.
UWAGA - każdy temat będzie trzeba trochę dostosować - wyjaśnię jak to zrobić.
...
Projekt może być podzielony na oddzielne projekty będące osobnymi programami. Ważne aby miały spójny format wywołania (argumenty/dane...).
dowolny język programowania, ale będę się czepiał wtórnych rozwiązań
